...
4. **Stage 4: Modal Perfection (v1.2.8)**: The Board Member selection in the settings modal has been perfected with vertical tiling, model description integration, dual pricing display, and a smart main/substitute mode switch.
